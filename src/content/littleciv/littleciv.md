...
To be clear, this end is not the death of humanity per se; but it is the end of our current relationship to the earth, of current economics, consumption, and energy. This end, of course, will be a new beginning; one that we either have made by choice, managing to maintain or deeper our civilizational complexity, or a new beginning where we are fighting a rear-guard action against the decay and loss of the civilizational complexity that we once had. Of course, there are a distribution of outcomes between those two 'beginning', with partial adaptation but the current probabilities are skewed towards the negative outcome as it stands. 
